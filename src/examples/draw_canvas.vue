<template>
    <div id="draw">
        <div><h2 class="title" style="float: left;padding-left:calc(35vw);margin-top: 5px;">手写板</h2><el-button style="margin-top: 3px;
    margin-left: 15px;" @click="showhint()" type="info" round>查看帮助</el-button></div>
...
export default {
    ...
    methods:{
         ...
         */
         showhint() {
        this.$alert('支持+ - × ÷ ( )的使用，可用在算式中用字母n表示上一次计算结果', '使用帮助', {
